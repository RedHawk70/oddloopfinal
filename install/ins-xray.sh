...
# JSON TEST1
cat> /usr/local/etc/xray/vlessc.json << END
{
  "log": {
    "access": "/var/log/xray/access.log",
    "error": "/var/log/xray/error.log",
...
# JSON TEST2
cat> /usr/local/etc/xray/vmessc.json << END
{
  "log": {
    "access": "/var/log/xray/access2.log",
    "error": "/var/log/xray/error.log",
...
#VMESS
mkdir -p /var/log/xray
touch /var/log/xray/access2.log /var/log/xray/error.log

chown -R www-data:www-data /var/log/xray
chmod 750 /var/log/xray
chmod 640 /var/log/xray/access2.log /var/log/xray/error.log

#TROJAN TCP
mkdir -p /var/log/xray
touch /var/log/xray/access3.log /var/log/xray/error.log

chown -R www-data:www-data /var/log/xray
chmod 750 /var/log/xray
chmod 640 /var/log/xray/access3.log /var/log/xray/error.log

#TROJAN WS
mkdir -p /var/log/xray
touch /var/log/xray/access4.log /var/log/xray/error.log

chown -R www-data:www-data /var/log/xray
chmod 750 /var/log/xray
chmod 640 /var/log/xray/access4.log /var/log/xray/error.log

#VLESS XTLS
mkdir -p /var/log/xray
touch /var/log/xray/access5.log /var/log/xray/error.log

chown -R www-data:www-data /var/log/xray
chmod 750 /var/log/xray
chmod 640 /var/log/xray/access5.log /var/log/xray/error.log
...
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/menu/xraay.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay

# Install Xraycore Mod 1.7.2-1 (Custompath)
mv /usr/local/bin/xray /usr/local/bin/xray.bakk && wget -q -O /usr/local/bin/xray "https://github.com/NiL070/XrayCoreChanger/releases/download/Xray-CoreMod_v1.7.2-1/Xray-linux-64-v1.7.2-1" && chmod 755 /usr/local/bin/xray
