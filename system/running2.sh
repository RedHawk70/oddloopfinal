...
echo -e ""
echo -e "\e[1;33mSTATUS XRAY VLESS/VMESS\e[0m"
echo -e "\e[1;33m/XHTTP/HTTPUPGRADE/TROJAN:\e[0m"
echo -e "\e[0;34m-----------------------\e[0m"
...
if [ "${status_text}" == "active" ]
then
echo -e " ➣ Xray Tls                : "$green"running"$NC" ✓"
else
echo -e " ➣ Xray Tls                : "$red"not running (Error)"$NC" "
fi
...
if [ "${status_text}" == "active" ]
then
echo -e " ➣ Xray None Tls           : "$green"running"$NC" ✓"
else
echo -e " ➣ Xray None Tls           : "$red"not running (Error)"$NC" "
fi
