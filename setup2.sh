...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/ssh-vpn2.sh && chmod +x ssh-vpn2.sh && screen -S ssh-vpn ./ssh-vpn2.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/ins-xray2.sh && chmod +x ins-xray2.sh && screen -S ins-xray ./ins-xray2.sh
...
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/websocket-python/websocket2.sh && chmod +x websocket2.sh && screen -S websocket.sh ./websocket2.sh
...
echo "   - Websocket SSL(HTTPS)      : 2053"  | tee -a log-install.txt
