...
# ================================
wget -q -O /usr/local/bin/ws-https https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/${namafolder}/ws-https
chmod +x /usr/local/bin/ws-https

wget -q -O /usr/local/bin/ws-http https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/${namafolder}/ws-http
