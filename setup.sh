...
# ================== AUTH + IP MODE CONFIG ==================
LICENSE_KEY_VALID="vip-nilphreakz@007"   # fallback (backward compatible)

GITHUB_OWNER="${GitUser}"
GITHUB_REPO="oddloop"
GITHUB_FILE="allowed_ips.txt"
GITHUB_LICENSE_FILE="licenses.txt"  # format: LicenseKey|DD/MM/YYYY or LIFETIME
...
echo "╚═╝  ╚═══╝╚═╝╚══════╝╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝";
echo "                                                              "
echo -e "${Lyellow}⚡PREMIUM SCRIPT V2.0 (MULTIPORT + OLD XRAYCORE V.1.7.2-1 SUPPORT MULTIPATH ) ⚡${RESET}"
echo -e "${green}.............................................................................${RESET}"
echo
sleep 1
...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install ohp-server
echo -e "\e[0;32mINSTALLING OHP PORT...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
echo -e "\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oddloopfinal/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
echo "   - Vmess Multipath NoneTls : 8880"  | tee -a log-install.txt
echo "   - Vless Multipath NoneTls : 8080"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════ Autoscript By NiLphreakz ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         PREMIUM BY NiLphreakz            |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
